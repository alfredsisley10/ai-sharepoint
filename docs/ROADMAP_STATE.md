...
- QUEUED (user, this session): 0.8.0 — Power BI (cloud) connector: connect + analyze (workspaces/datasets/reports listing, read-only DAX executeQueries); AAD delegated via existing MSAL providers (api.powerbi.com, powerbi scopes).
