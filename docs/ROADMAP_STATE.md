...
- QUEUED (user, this session): (a) Communication Channels — Teams chat + Outlook mail connectors, draft-with-AI → user approves → send via Graph (ADR-0021-style gates); (b) Vertex AI Search connector (vertexaisearch.cloud.google, enterprise Gemini, SSO) for search/analysis.
