...
| Remaining §9.2 adapters (Intune, Databricks, Aternity, AppDynamics, Azure/O365 consoles, Workday; Oracle excluded per ADR-0022; Splunk SHIPPED 0.10.0, ServiceNow 0.9.0, Vertex 0.7.0, Power BI 0.8.0, Splunk Observability Cloud/SignalFx + Grafana 0.23.0) | Each needs live-instance validation; framework seam proven by 15 adapters |
