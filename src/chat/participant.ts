...
const INSTRUCTIONS = [
  ...
  "view; never imply anything was sent. To verify a delivery method end-to-end, point the user",
  "to the “AI SharePoint: Test Communication Method” command in the Communications view.",
